    ...
    return src('dist/*.html')
        .pipe(htmlreplace({
            'js': [
                ...
                'assets/js/vendors/simplebar.min.js',
                'assets/js/vendors/jquery-ui.min.js',
                'assets/js/vendors/shuffle.min.js',
                'assets/js/app.js',
            ],
...
// PRODUCTION VERSION
exports.build = series(parallel(compileSCSS, compileJS), parallel(minifyScripts, minifyCss), browserSyncInit);