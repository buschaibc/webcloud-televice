...
document.addEventListener("DOMContentLoaded", function () {
	...
	scrollToTarget.forEach(function(targetElement) {
		targetElement.addEventListener('click', function() {
			...
			if (target) {
				window.scrollTo({
					top: 0,  // Set top to 0 when scrolling to top
					behavior: 'smooth'
				});
			}
		});
	...
	for (let i = 0; i < priceControlBtn.length; i++) {
		priceControlBtn[i].addEventListener(
			"click",
			(function (index) {
				return function () {
...
$(function () {
	...
	$(".vps-slider--core").slider({
		...
		slide: function (event, ui) {
			...
			if (vpsRangeVal == 1) {
				$(".vps-slider__progress-1").css({ width: "0" });
			} else if (vpsRangeVal == 2) {
				$(".vps-slider__progress-1").css({ width: "20%" });
			} else if (vpsRangeVal == 3) {
				$(".vps-slider__progress-1").css({ width: "40%" });
			} else if (vpsRangeVal == 4) {
				$(".vps-slider__progress-1").css({ width: "60%" });
			} else if (vpsRangeVal == 5) {
				$(".vps-slider__progress-1").css({ width: "80%" });
			} else if (vpsRangeVal == 6) {
				$(".vps-slider__progress-1").css({ width: "100%" });
			}
		},
	});
	...
	$(".vps-slider--ram").slider({
		...
		slide: function (event, ui) {
			...
			var vpsRangeVal = vpsRange.val();
			if (vpsRangeVal == 1) {
				$(".vps-slider__progress-2").css({ width: "0" });
			} else if (vpsRangeVal == 2) {
				$(".vps-slider__progress-2").css({ width: "20%" });
			} else if (vpsRangeVal == 3) {
				$(".vps-slider__progress-2").css({ width: "40%" });
			} else if (vpsRangeVal == 4) {
				$(".vps-slider__progress-2").css({ width: "60%" });
			} else if (vpsRangeVal == 5) {
				$(".vps-slider__progress-2").css({ width: "80%" });
			} else if (vpsRangeVal == 6) {
				$(".vps-slider__progress-2").css({ width: "100%" });
			}
		},
	});
	...
	$(".vps-slider--ssd").slider({
		...
		slide: function (event, ui) {
			...
			var vpsRangeVal = vpsRange.val();
			if (vpsRangeVal == 1) {
				$(".vps-slider__progress-3").css({ width: "0" });
			} else if (vpsRangeVal == 2) {
				$(".vps-slider__progress-3").css({ width: "20%" });
			} else if (vpsRangeVal == 3) {
				$(".vps-slider__progress-3").css({ width: "40%" });
			} else if (vpsRangeVal == 4) {
				$(".vps-slider__progress-3").css({ width: "60%" });
			} else if (vpsRangeVal == 5) {
				$(".vps-slider__progress-3").css({ width: "80%" });
			} else if (vpsRangeVal == 6) {
				$(".vps-slider__progress-3").css({ width: "100%" });
			}
		},
	});
